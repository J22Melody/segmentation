...
```
    ...
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse/metadata_test_de_dsgs.csv
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse/metadata_test_dsgs_de.csv
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse/example_mediapipe
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse/example_openpose
    OK   /shares/sign-language.ebling.cl.uzh/Signsuisse/example_videos
...
```
    ...
    metadata_test_de_dsgs.csv         250 rows,  250 unique ids
    metadata_test_dsgs_de.csv         250 rows,  250 unique ids
    
    overlap between the two direction files: 0
    
    500 distinct DSGS test examples
    languages: {('de', 'dsgs'): 500}
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>de</td>
      <td>dsgs</td>
      <td>Veranstaltung/Medien</td>
      <td>Bild und Ton in zeitliche Übereinstimmung brin...</td>
      <td>übereinstimmen, aufeinander abstimmen z. B. Bi...</td>
      <td>Über eine Meldung auf dem iPhone werde ich auf...</td>
      <td>https://signsuisse.sgb-fss.ch/lexikon/117615/s...</td>
      <td>2.625</td>
      <td>5.834</td>
    </tr>
    <tr>
      ...
      <td>dsgs</td>
      <td>Wirtschaft</td>
      <td>Der Schweizerische Nationalfonds zur Förderung...</td>
      <td>Schweizerische Stiftung</td>
      <td>Der Nationalfonds unterstützt vor allem Forsch...</td>
      <td>https://signsuisse.sgb-fss.ch/lexikon/117580/n...</td>
      <td>3.417</td>
      <td>7.667</td>
    </tr>
    <tr>
      ...
      <td>dsgs</td>
      <td>Medizin</td>
      <td>die menschliche Schwangerschaft unterbrechen</td>
      <td>eine Schwangerschaft abbrechen</td>
      <td>Die Schwangerschaft dieser Frau verläuft nicht...</td>
      <td>https://signsuisse.sgb-fss.ch/lexikon/112471/a...</td>
      <td>2.720</td>
      <td>7.160</td>
    </tr>
  </tbody>
...
```
    ...
    ids in no_example_ids.txt that are in our set: 0
...
```
    ...
    === SignSuisse DSGS test set — basic statistics ===
    
      examples                    500
      unique lexical entries      496
      categories                  25
      total example video         48.1 min
      total isolated sign video   22.1 min
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>isolated sign (s)</th>
      <th>words in sentence</th>
      <th>chars in sentence</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
```
      ...
      total example video        48.1 min
      DGS reference rate         1.35 signs/s
      est. signs total           3,903
      est. signs per clip        7.8
      German words per sentence  8.5 (mean)
...
```
    ...
    read 500 ELAN files, 4,581 predicted sign segments
...
```
    ...
    === 2023 model predictions on the DSGS test set ===
    
      clips                       500
      predicted sign segments     4,581
      predicted phrase segments   965
      signs per clip              mean 9.2  median 9  range 2–22
      clips with no sign          0
      mean coverage of clip       52.2%
      SIGN_MANUAL annotations     0 (expected 0 before annotation)
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      <th></th>
      <th>predicted sign duration (ms)</th>
      <th>signs per clip</th>
      <th>coverage of clip</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
![png](explore_files/explore_23_0.png)
