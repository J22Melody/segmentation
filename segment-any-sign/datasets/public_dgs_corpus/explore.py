...
#
# To produce a tracked HTML report:
#
# ```bash
# jupytext --to notebook --execute explore.py -o reports/explore.ipynb
# jupyter nbconvert --to html reports/explore.ipynb --output-dir reports
# ```
#
# `reports/*.html` is tracked in git; the generated `.ipynb` is not.
